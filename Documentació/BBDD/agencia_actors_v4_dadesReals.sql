...
--
-- Servidor: 127.0.0.1
-- Temps de generació: 02-04-2017 a les 21:13:51
...
--
ALTER TABLE `paper`
  MODIFY `idPaper` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
-- AUTO_INCREMENT per la taula `pelicula`
--
ALTER TABLE `pelicula`
  MODIFY `idPelicula` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
--
