            ...
            <form class="form-horizontal" method="post" action="?ctl=pelicula&act=modificar" enctype='multipart/form-data'>
                ...
                <div class="form-group">
                    ...
                    <div class="cols-sm-10">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="tipus" id="email"  placeholder="Tipus" value="<?php echo (isset($x) ? $x->getTipus() : '') ?>"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="cols-sm-10">
                        <div class="input-group">
                            ...
                            <input type="date" class="form-control" name="datainici" id="username"  placeholder="DD/MM/YYYY" value="<?php echo (isset($x) ? $x->getDataInici() : '') ?>"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="cols-sm-10">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-calendar fa" aria-hidden="true"></i></span>
                            <input type="date" class="form-control" name="datafi" id="username"  placeholder="DD/MM/YYYY" value="<?php echo (isset($x) ? $x->getDataFi() : '') ?>"/>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="cols-sm-10">
                        <div class="input-group">
                            ...
                            <textarea name="descripcio" rows="5" cols="30" class="form-control" id="message" required data-validation-required-message="Please enter your message" maxlength="999" style="resize:none"><?php echo (isset($x) ? $x->getDescripcio() : '') ?></textarea>
                        </div>
                    </div> 
                <!--                Select-->
